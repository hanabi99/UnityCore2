...
namespace MyGameFrameWork {
    public class UIManager : Singleton<UIManager>
    {
        ...
        public bool isStudyDone;
        public bool isFinish;
        public bool isVRFinish;
        ...
        public void AutoRegister()
        {
            ...
            if (uiRoot.transform.FindMyChild("FadePanel") != null)
            {
                FadePanel = uiRoot.transform.FindMyChild("FadePanel").GetComponent<CanvasGroup>();
            }
