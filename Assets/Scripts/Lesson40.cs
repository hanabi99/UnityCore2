...
{
    public UnityEngine.U2D.Animation.SpriteResolver sr;

    private Dictionary<string, UnityEngine.U2D.Animation.SpriteResolver> equipDic = new Dictionary<string, UnityEngine.U2D.Animation.SpriteResolver>();
    ...
    void Start()
    {
        ...
        UnityEngine.U2D.Animation.SpriteResolver[] srs = this.GetComponentsInChildren<UnityEngine.U2D.Animation.SpriteResolver>();
